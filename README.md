...
教材部署完成後，可請 Claude Code 產生**中英雙語臉書宣傳文**，並附「一鍵複製」互動卡片。

- 若同時安裝了 [`social-post`](https://github.com/Hao0321/claude-skill-social-post) skill（作者：駱君昊 Hao，MIT），本 skill 會自動套用它的爆款公式（預設 F15 mini 極簡開源型）、語氣鐵則與安全規則。
- 重要：依 social-post 的 R25 規則，**GitHub／教材連結不放正文，改放第一則留言**，正文用「留言『教材』我傳你」的關鍵詞 CTA。
- 細節見 `references/facebook-post.md`。
